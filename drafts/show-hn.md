...
Every formula is documented at /methodology, the suite passes 116 automated tests including 10 scenario vectors derived by hand independently of the code, and every scenario is a shareable URL.
...
1. "37 tests" -> "107 automated tests". The site publishes TEST_COUNT=116 (as of 2026-08-12)
