...
1. **Comparable rent.** Use rent for the same home you would buy — size, condition, neighborhood — not your current smaller apartment. Overstating it is the most common way people talk themselves into buying.
2. **Your quoted rate and down payment.** Use your actual loan quote, not a headline average. The model handles PMI with automatic cancellation if you put down less than 20%, and supports all-cash purchases.
3. **Stay length.** Be honest about jobs, relationships, and schools. Every table above shows the verdict swinging on this input.
4. **Taxes.** The model compares the standard deduction against itemizing (2026 SALT cap of $40,400, mortgage interest capped at $750,000 of principal) and applies the Section 121 exclusion at sale. Outside the US, the calculator is currency-agnostic — zero out the US tax fields and the mechanics still hold.
