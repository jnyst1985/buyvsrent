...
`src/lib/engine/` is a framework-agnostic TypeScript simulation covered by **57 tests**, including 10 verification vectors independently derived with closed-form math (amortization tables, annuity formulas, hand-enumerable zero-rate scenarios). Run them:
